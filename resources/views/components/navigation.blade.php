<nav class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if(auth()->user()->is_caregiver)
                        <x-nav-link :href="route('caregiver.patients')" :active="request()->routeIs('caregiver.patients')">
                            {{ __('Pacienții mei') }}
                        </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('voice.interface')" :active="request()->routeIs('voice.interface')">
                {{ __('Asistent Vocal') }}
            </x-responsive-nav-link>
        </div>
